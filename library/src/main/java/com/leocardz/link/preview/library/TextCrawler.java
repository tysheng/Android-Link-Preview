...
public class TextCrawler {
    ...
    public SourceContent makePreviewSync(String url) {
        SourceContent sourceContent = new SourceContent();
        process(sourceContent, 1, url);
    ...
    public class GetCode extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if (callback != null) {
                callback.onPos(sourceContent, isNull(sourceContent));
            }
        ...
        protected Void doInBackground(String... params) {
            process(sourceContent, imageQuantity, params[0]);
            return null;
        }
